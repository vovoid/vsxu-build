...
const char * LIB_PATH_VALUE   = "Z:\\home\\jaw\\vsxu\\build\\win64\\dependencies\\jpeg-8c\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "Z:\\home\\jaw\\vsxu\\build\\win64\\dependencies\\jpeg-8c\\.libs;Z:\\home\\jaw\\vsxu\\build\\win64\\dependencies-install\\lib;Z:\\home\\jaw\\vsxu\\build\\win64\\dependencies-install\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("        lt_dump_D=`$ECHO \"X$lt_script_arg0\" | /bin/sed -e 's/^X//' -e 's%/[^/]*$%%'`\n", f);
  fputs ("        test \"X$lt_dump_D\" = \"X$lt_script_arg0\" && lt_dump_D=.\n", f);
  fputs ("        lt_dump_F=`$ECHO \"X$lt_script_arg0\" | /bin/sed -e 's/^X//' -e 's%^.*/%%'`\n", f);
  ...
  fputs ("    echo \"jpegtran.exe:jpegtran:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"jpegtran.exe:jpegtran:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/home/jaw/vsxu/build/win64/dependencies/jpeg-8c/.libs:/home/jaw/vsxu/build/win64/dependencies-install/lib:/home/jaw/vsxu/build/win64/dependencies-install/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/jaw/vsxu/build/win64/dependencies/jpeg-8c/.libs:$PATH\"\n", f);
  fputs ("\n", f);
